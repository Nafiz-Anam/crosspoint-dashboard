...
const ResetPasswordOTPIllustration = styled('img')(({ theme }) => ({
  zIndex: 2,
  blockSize: 'auto',
  maxBlockSize: 650,
  maxInlineSize: '100%',
...
const ResetPasswordOTP = ({ mode }) => {
  ...
  useEffect(() => {
    ...
    if (emailParam && otpParam) {
      ...
      setError(t('auth.invalidResetData'))
    }
  }, [searchParams, t])
  ...
  return (
    <div className='flex bs-full justify-center'>
      ...
      >
        <ResetPasswordOTPIllustration src={characterIllustration} alt='character-illustration' />
        {!hidden && (
          <MaskImg
            alt='mask'
            src={authBackground}
